...
class GFEntryDetail {
	...
	public static function lead_detail_page() {
		...
		?>
		<form method="post" id="entry_form" enctype='multipart/form-data' action="?page=gf_entries&view=entry&id=<?php echo($form_id);?>&lid=<?php echo($lead_id);?>&orderby=ASC&filter&paged=1
&pos=0&field_id&operator">
